...
if __name__ == '__main__':
    ...
    parser.add_argument('-x', '--expert', action="store_true", help='Toggle warning')
    parser.add_argument('-i', '--api-key', action="store_true", help='Clear API key')
